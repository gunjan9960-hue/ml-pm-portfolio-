...
| # | Notebook | Model type | Score | Key PM insight |
|---|---------|-----------|-------|----------------|
| 1 | [01-kkbox-churn.ipynb](./01-kkbox-churn.ipynb) | XGBoost Classification | AUC 0.981 · F1 0.749 | Churn is billing friction not disengagement |
...
- Kaggle: https://kaggle.com/gunjan9960
- Notion: [Add your Notion portfolio link]
